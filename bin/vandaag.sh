...

{
  ...
  echo "groenteman:appel, mandarijn/sinaasappel"
  echo "kwark:alpro perzik"
  echo "kwark:alpro aardbei"
  echo "kwark:alpro kersen"
  echo "kwark:alpro vanille"
  echo "kwark:alpro bosbessen"
  echo "boter:danio bosbessen"
  echo "boter:danio kersen"
  echo "boter:danio kiwi"
  echo "boter:danio perzik"
  echo "boter:danio vanille"
  echo "boter:vanillevla"
} >> "${output_file}"
